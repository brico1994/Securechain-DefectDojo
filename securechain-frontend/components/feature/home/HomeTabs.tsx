...
import { UserDefectDojoTab } from '@/components/feature/defectdojo'
      ...
      <div className="max-w-6xl mx-auto">
        <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
          <TabsList className="grid w-full grid-cols-5 h-auto gap-1 sm:gap-2 p-1 sm:p-2">
            ...
            >
              <Shield className="h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />
              <span className="text-center leading-none break-words max-w-full">DefectDojo</span>
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="user-dojo" className="mt-2 sm:mt-4 md:mt-6">
            <UserDefectDojoTab />
          </TabsContent>
        </Tabs>
