export const API_ENDPOINTS = {
  ...
  DEFECTDOJO: {
    GENERIC_FINDINGS: {
      GENERATE: '/api/defectdojo/generic-findings/generate',
      DOCUMENTS: '/api/defectdojo/generic-findings/documents',
      DOCUMENT_DETAIL: (documentId: string) =>
        `/api/defectdojo/generic-findings/documents/${documentId}`,
      IMPORT: (documentId: string) =>
        `/api/defectdojo/generic-findings/documents/${documentId}/import`,
    },
  }
} as const
